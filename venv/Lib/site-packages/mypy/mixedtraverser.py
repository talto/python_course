...
from mypy.nodes import (AssertTypeExpr, AssignmentStmt, CastExpr, ClassDef,
                        ForStmt, FuncItem, NamedTupleExpr, NewTypeExpr,
                        PromoteExpr, TypeAlias, TypeAliasExpr, TypeAliasStmt,
