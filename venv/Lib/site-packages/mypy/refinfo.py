...
from mypy.nodes import (LDEF, Expression, FuncDef, MemberExpr, MypyFile,
                        NameExpr, RefExpr, SymbolNode, TypeInfo)
from mypy.traverser import TraverserVisitor
from mypy.typeops import tuple_fallback
from mypy.types import (FunctionLike, Instance, TupleType, Type, TypeType,
