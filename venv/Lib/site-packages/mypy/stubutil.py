...
from mypy.nodes import (PARAM_SPEC_KIND, TYPE_VAR_TUPLE_KIND, ClassDef,
                        FuncDef, TypeAliasStmt)
from mypy.stubdoc import ArgSig, FunctionSig
from mypy.types import (AnyType, NoneType, Type, TypeList, TypeStrVisitor,
