...
from mypy.nodes import (ARG_POS, CallExpr, Decorator, Expression, FuncDef,
                        RefExpr, Var)
from mypy.semanal_shared import SemanticAnalyzerInterface
from mypy.typeops import function_type
from mypy.types import (AnyType, CallableType, ProperType, Type, TypeOfAny,
                        TypeVarType, get_proper_type)
