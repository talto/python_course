...
from mypy.nodes import (ARG_NAMED, ARG_POS, LDEF, AssertTypeExpr,
                        AssignmentExpr, BytesExpr, CallExpr, CastExpr,
                        ComparisonExpr, ComplexExpr, ConditionalExpr, DictExpr,
                        DictionaryComprehension, EllipsisExpr, Expression,
                        FloatExpr, GeneratorExpr, IndexExpr, IntExpr,
                        ListComprehension, ListExpr, MemberExpr, MypyFile,
                        NameExpr, OpExpr, RefExpr, SetComprehension, SetExpr,
                        SliceExpr, StarExpr, StrExpr, SuperExpr, TupleExpr,
                        TypeApplication, TypeInfo, TypeVarLikeExpr, UnaryExpr,
                        Var)
from mypy.types import (Instance, ProperType, TupleType, TypeType,
                        get_proper_type)
from mypyc.common import MAX_SHORT_INT
from mypyc.ir.class_ir import ClassIR
from mypyc.ir.func_ir import FUNC_CLASSMETHOD, FUNC_STATICMETHOD
from mypyc.ir.ops import (Assign, BasicBlock, ComparisonOp, Integer,
                          LoadAddress, LoadLiteral, PrimitiveDescription,
                          RaiseStandardError, Register, TupleGet, TupleSet,
                          Value)
from mypyc.ir.rtypes import (RTuple, bool_rprimitive, int_rprimitive,
...
from mypyc.irbuild.for_helpers import (
    comprehension_helper, raise_error_if_contains_unreachable_names,
    translate_list_comprehension, translate_set_comprehension)
from mypyc.irbuild.format_str_tokenizer import (convert_format_expr_to_bytes,
                                                convert_format_expr_to_str,
                                                join_formatted_bytes,
                                                join_formatted_strings,
                                                tokenizer_printf_style)
from mypyc.irbuild.specialize import (apply_function_specialization,
...
from mypyc.primitives.list_ops import (list_append_op, list_extend_op,
                                       list_slice_op)
from mypyc.primitives.misc_ops import (ellipsis_op, get_module_dict_op,
                                       new_slice_op, type_op)
