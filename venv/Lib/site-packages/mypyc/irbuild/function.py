...
from mypy.nodes import (ArgKind, ClassDef, Decorator, FuncBase, FuncDef,
                        FuncItem, LambdaExpr, OverloadedFuncDef, SymbolNode,
                        TypeInfo, Var)
...
from mypyc.ir.ops import (BasicBlock, GetAttr, InitStatic, Integer,
                          LoadAddress, LoadLiteral, Register, Return, SetAttr,
...
from mypyc.irbuild.env_class import (finalize_env_class, load_env_registers,
...
from mypyc.irbuild.generator import (
    ...
    create_switch_for_generator_class, gen_generator_func,
    populate_switch_for_generator_class, setup_env_for_generator_class)
